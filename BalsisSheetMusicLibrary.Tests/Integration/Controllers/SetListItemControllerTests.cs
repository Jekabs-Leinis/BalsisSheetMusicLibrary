...
public class SetListItemControllerTests : IntegrationTestBase
{
    ...
    {
        // Arrange
        var sheetMusic1 = new Entities.SheetMusic { Id = 1, Title = "Sheet 1" };
        var sheetMusic2 = new Entities.SheetMusic { Id = 2, Title = "Sheet 2" };
        var setList = new Entities.SetList { Id = 1, Title = "Set" };
        
        UnitOfWork.SheetMusic.AddRange([sheetMusic1, sheetMusic2]);
        UnitOfWork.SetLists.Add(setList);
        await UnitOfWork.SaveChangesAsync(TestContext.Current.CancellationToken);

        var item1 = new Entities.SetListItem { SetListId = 1, SheetMusicId = 1, Order = 1 };
        var item2 = new Entities.SetListItem { SetListId = 1, SheetMusicId = 2, Order = 2 };
        UnitOfWork.SetListItems.AddRange([item1, item2]);
        await UnitOfWork.SaveChangesAsync(TestContext.Current.CancellationToken);

        var dto = new MoveSetListItemDto { SetListId = 1, SheetMusicId = 1, NewOrder = 2 };
    ...
    {
        // Arrange
        var dto = new MoveSetListItemDto { SetListId = 999, SheetMusicId = 1, NewOrder = 1 };
    ...
    [Fact]
    public async Task Move_WithInvalidSheetMusicId_ReturnsBadRequest()
    {
        // Arrange
        var setList = new Entities.SetList { Id = 1, Title = "Set" };
        UnitOfWork.SetLists.Add(setList);
        ...
        var dto = new MoveSetListItemDto { SetListId = 1, SheetMusicId = 999, NewOrder = 1 };
    ...
    {
        // Arrange
        var dto = new MoveSetListItemDto { SetListId = 1, SheetMusicId = 1, NewOrder = 1 };
