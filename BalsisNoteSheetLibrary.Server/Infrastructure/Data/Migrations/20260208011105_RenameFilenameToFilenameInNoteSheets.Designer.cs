...
namespace BalsisNoteSheetLibrary.Server.Migrations
{
    ...
    [Migration("20260208011105_RenameFilenameToFilenameInNoteSheets")]
    partial class RenameFilenameToFilenameInNoteSheets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Domain.Entities.NoteSheet", b =>
                {
                    b.Property<uint>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Domain.Entities.SetList", b =>
                {
                    b.Property<uint>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Domain.Entities.SetListItem", b =>
                {
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Domain.Entities.SetListItem", b =>
                {
                    b.HasOne("BalsisNoteSheetLibrary.Server.Domain.Entities.NoteSheet", "NoteSheet")
                        .WithMany("SetListItems")
                        .HasForeignKey("NoteSheetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BalsisNoteSheetLibrary.Server.Domain.Entities.SetList", "SetList")
                        .WithMany("Items")
