...
namespace BalsisNoteSheetLibrary.Server.Migrations
{
    ...
    [Migration("20250907202958_AddSystemFileNameToNoteSheet")]
    partial class AddSystemFileNameToNoteSheet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Models.NoteSheet", b =>
                {
                    b.Property<uint?>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BalsisNoteSheetLibrary.Server.Models.SetListItem", b =>
                {
                    b.HasOne("BalsisNoteSheetLibrary.Server.Models.NoteSheet", "NoteSheet")
                        .WithMany("SetListItems")
                        .HasForeignKey("NoteSheetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BalsisNoteSheetLibrary.Server.Models.SetList", "SetList")
                        .WithMany("Items")
